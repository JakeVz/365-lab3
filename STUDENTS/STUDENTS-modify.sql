...
# wveazey@calpoly.edu & asingh54@calpoly.edu
...
UPDATE list SET Classroom = 120 WHERE LastName = 'FLACHS' AND FirstName = 'JEFFREY';
...
UPDATE list SET GPA = GPA * 1.10 WHERE LastName = 'JAGNEUX' AND FirstName = 'ELVIRA';
